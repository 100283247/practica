                    ...
                    <div  class="wrap">
                          <div class="Regisration">
                              ...
                              <form action="ServeletAltaCurso" method="post">
                                ...
                                <input name="duracion" type="text" placeholder="Horas de dedicaci&oacute;n" style="margin-top:60px">
                                ...
                                <select name="programa" style="margin-top:5px; color:#D8D8D8">   
                                    <option style="color:grey" selected disabled>Método de pago</option>
                                    <option style="color:grey" value="Básico">PayPal</option>
                                    <option style="color:grey" value="Intermedio">Transferencia bancaria</option>
                                    <option style="color:grey" value="Avanzado">Domiciliación bancaria</option>
                                </select>
                                <div class="Remember-me">
                                <div class="submit">
                                    <input type=submit name="altacurso" onclick="myFunction()" style="color:white" value=Crearcurso>
